...
const HELP_SELECTION_PATH := "res://ui/menu/StudentMenu/help.tscn"
...
@onready var btn3: Button = $CenterContainer/Menu/BtnHelp
...
@onready var btn_Help: BaseButton =  $CenterContainer/Menu/BtnHelp
